...
window._wpemojiSettings = { "baseUrl": "https:\/\/s.w.org\/images\/core\/emoji\/2.4\/72x72\/", "ext": ".png", "svgUrl": "https:\/\/s.w.org\/images\/core\/emoji\/2.4\/svg\/", "svgExt": ".svg", "source": { "concatemoji": "\/source\/js\/wp-emoji-release.min.js" } };
! function(a, b, c) {
    function d(a, b) {
...
WebFontConfig = {
    ...
    var wpcf7 = {
        "apiSettings": {
            "root": "http:\/\/localhost:8888\/website\/wordpress\/wp-json\/contact-form-7\/v1",
    ...
    var flatsomeVars = {
        "ajaxurl": "http:\/\/localhost:8888\/website\/wordpress\/wp-admin\/admin-ajax.php",
        "rtl": "",
        "sticky_height": "70"
    };